...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (20, 'Canoeing', 'Might be a little tipsy', 'Give your arms a workout', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Canoeing4_GrandMesa_GJCVB.jpg?itok=9TSNdUHX', '<i class=\"fas fa-ship\"></i>');
...
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (1, 4);
...
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (2, 7);
