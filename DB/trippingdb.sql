...
INSERT INTO `destination` (`id`, `name`, `description`, `image_url`, `short_description`) VALUES (6, 'Aspen', 'While Aspen, Colorado is known as a travel destination frequented by the rich and famous, Aspen visitors and locals know this beautiful Colorado mountain town for its four ski resorts—Aspen Mountain, Snowmass Mountain, Aspen Highlands Mountain, and Buttermilk Mountain--as well as its variety of outdoor activities, arts programs, cultural events, and cosmopolitan nightlife. Aspen offers restaurants, shopping, lodging, and nightlife that cater to a range of budgets and experiences. Aspen also emphasizes preserving the environment, celebrating its silver mining heritage, and promoting the arts, culture, and local non-profits.', 'https://kunversion-frontend-blog.s3.amazonaws.com/images/b96ac12358c531ee677a6137583b457cd04fddb5.jpg', 'Aspen is located in the Rocky Mountains at an elevation of 7,815 feet and encompasses 1.99 square miles. It is the 50th largest city in Colorado and is approximately 200 miles southwest of Denver. Aspen is located at the southern end of the lush Roaring Fork Valley, along with the neighboring cities of Glenwood Springs, Carbondale, El Jebel, and Basalt.');
...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (38, 'Horseback Riding Tours', 'The original All Terrain Vehicle', 'You are kinda high off the ground, hold on.', 'http://bozeman-horseback-riding.com/wp-content/uploads/2012/04/Day-Riders-Spanish-Peaks.jpg', '<i class=\"fas fa-horse\"></i>');
