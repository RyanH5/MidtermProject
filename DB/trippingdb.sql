...
START TRANSACTION;
USE `trippingdb`;
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (1, '1119 Zazpo Place', '1120 Zazpo Place', 'Denver', 'CO', '80123', '970-947-2926', 39.7392, 104.9903);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (2, '233 Ledci Pass', '234 Ledci Pass', 'Denver', 'CO', '80205', '970-947-2927', 39.7392, 104.9903);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (3, '1614 Lerad Highway', '1615 Lerad Highway', 'Denver', 'CO', '80022', '970-947-2928', 39.7392, 104.9903);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (4, '1635 Zocuge Turnpike', '1636 Zocuge Turnpike', 'Denver', 'CO', '80123', '970-947-2929', 39.7392, 104.9903);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (5, '193 Vegma Plaza', '194 Vegma Plaza', 'Gunnison', 'CO', '81230', '970-947-2930', 38.5458, 106.9253);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (6, '705 Dekif Center', '706 Dekif Center', 'Gunnison', 'CO', '81231', '970-947-2931', 38.5458, 106.9253);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (7, '407 Jacoz Mill', '408 Jacoz Mill', 'Gunnison', 'CO', '81230', '970-947-9262', 38.5458, 106.9253);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (8, '935 Igsik Center', '936 Igsik Center', 'Gunnison', 'CO', '81231', '970-947-9263', 38.5458, 106.9253);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (9, '1965 Tugo Street', '1966 Tugo Street', 'Durango', 'CO', '81301', '970-947-9264', 37.2753, 107.8801);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (10, '1781 Lahe Court', '1782 Lahe Court', 'Durango', 'CO', '81302', '970-947-9265', 37.2753, 107.8801);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (11, '1484 Ofjim Drive', '1485 Ofjim Drive', 'Durango', 'CO', '81301', '970-947-9266', 37.2753, 107.8801);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (12, '1601 Jucfup Trail', '1602 Jucfup Trail', 'Durango', 'CO', '81302', '970-997-2962', 37.2753, 107.8801);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (13, '1286 Limcet Manor', '1287 Limcet Manor', 'Durango', 'CO', '81301', '970-997-2963', 37.2753, 107.8801);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (14, '144 Ipufe Lane', '145 Ipufe Lane', 'Aspen', 'CO', '81611', '970-997-2964', 39.1911, 106.8175);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (15, '462 Nezav Grove', '463 Nezav Grove', 'Aspen', 'CO', '81612', '970-997-2965', 39.1911, 106.8175);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (16, '401 North River Street', '402 North River Street', 'Glenwood Springs', 'CO', '81601', '970-947-2955', 39.5505, 107.3248);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (17, '1386 Tagpic Boulevard', '1387 Tagpic Boulevard', 'Glenwood Springs', 'CO', '81602', '970-947-2956', 39.5505, 107.3248);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (18, '60 Zofij Road', '61 Zofij Road', 'Glenwood Springs', 'CO', '81601', '970-947-2957', 39.5505, 107.3248);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (19, '1912 Fazfo Park', '1913 Fazfo Park', 'Glenwood Springs', 'CO', '81602', '970-947-2958', 39.5505, 107.3248);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (20, '509 Cigod Way', '510 Cigod Way', 'Glenwood Springs', 'CO', '81601', '970-947-2959', 39.5505, 107.3248);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (21, '13 Noel Road', '14 Noel Road', 'Boulder', 'CO', '80301', '970-947-2960', 40.015, 105.2705);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (22, '1896 Pavbec River', '1897 Pavbec River', 'Boulder', 'CO', '80303', '970-947-2961', 40.015, 105.2705);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (23, '1199 Cupo Key', '1200 Cupo Key', 'Boulder', 'CO', '80301', '970-947-2962', 40.015, 105.2705);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (24, '884 Hagfob Trail', '885 Hagfob Trail', 'Boulder', 'CO', '80303', '970-747-2962', 40.015, 105.2705);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (25, '213 Sujas Junction', '214 Sujas Junction', 'Boulder', 'CO', '80301', '970-747-2963', 40.015, 105.2705);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (26, '1014 Nelov Avenue', '1015 Nelov Avenue', 'Colorado Springs', 'CO', '80908', '970-747-2964', 38.8339, 104.8214);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (27, '1146 Zulamo Parkway', '1147 Zulamo Parkway', 'Colorado Springs', 'CO', '80909', '970-747-2965', 38.8339, 104.8214);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (28, '824 Mupe Highway', '825 Mupe Highway', 'Colorado Springs', 'CO', '80908', '970-747-2966', 38.8339, 104.8214);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (29, '515 Zehla Turnpike', '516 Zehla Turnpike', 'Colorado Springs', 'CO', '80909', '970-947-2930', 38.8339, 104.8214);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (30, '1794 Nuwo Key', '1795 Nuwo Key', 'Colorado Springs', 'CO', '80908', '970-947-2931', 38.8339, 104.8214);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (31, '1836 Mosbah Turnpike', '1837 Mosbah Turnpike', 'Aspen', 'CO', '81611', '970-947-2932', 39.1911, 106.8175);
