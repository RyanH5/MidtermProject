...
START TRANSACTION;
USE `trippingdb`;
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (1, 'Bear Lake Rd', 'Bear Lake Rd', 'Estes Park', 'CO', '80517', '970-947-2926', 40.3129, -105.6464);
INSERT INTO `address` (`id`, `street_1`, `street_2`, `city`, `state`, `zip`, `phone`, `latitude`, `longitude`) VALUES (2, 'Mesa Verde', 'Mesa Verde', 'Mancos, CO', 'CO', '81328', '970-947-2927', 43.5827, -110.8219);
