...
USE `trippingdb`;
<<<<<<< HEAD
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (1, '4x4 & Jeep Tours', 'Jeep, jeeps, and more jeeps', 'Don\'t worry about bashing up you 4x4, let us do the driving.', 'https://coloradojeeptours.com/wp-content/uploads/chelsy-red-canyon-group.jpeg', '<i class=\"fas fa-truck-monster\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (2, 'Adventure Tours', 'No seriously, let us do the driving while you take in the scenery.', 'Lots to see and more', 'https://captainzipline.com/wp-content/uploads/colorado-zipline-tour-2.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (3, 'ATV', 'Be sure to wear a helmet', 'Stay on designated trails', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/CO_PhotoProject2007_0515_0.jpg?itok=WZNlrfiO', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (4, 'Dog Sledding', 'The dogs do the leg work', 'Dress warmly', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Dogsled3_Edwards_MI_3.jpg?itok=NpUTALq8', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (5, 'Guest/Dude Ranches', 'Watch where you step', 'If you desire to leave your clean, air conditioned, comfy home to come play on the ranch and get a little dirty, we welcome you.', 'https://duderanch.s3.amazonaws.com/2017/03/31/5038.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (6, 'Hang/Paragliding', 'Who needs a plane to fly', 'Ride the wind', 'https://www.uncovercolorado.com/wp-content/uploads/2014/04/Colorado-Paragliding01-1000x500-650x325.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (7, 'Hunting', 'Don\'t settle for store bought meats...', 'We have organic wildlife to hunt (with appropriate license)', 'http://kifaru.net/wp-content/uploads/2018/04/Alex_Nestor.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (8, 'Kayaking', 'Enjoy some time on the water', 'We offer both exciting white water and relaxing flat water kayaking', 'https://kayaksreviewed.com/wp-content/uploads/2018/06/img_8202-1024x683.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (9, 'Motorcycle Touring', 'Join the group with a few or many riders', 'Select the distance and group size you would like to ride with. Safety in numbers', 'https://www.advpulse.com/wp-content/uploads/2016/07/Rawhyde-High-Rockies-Adventure-2.jpg', NULL);
...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (11, 'Mountaineering', 'Conquere the high peaks', 'Looking for more than just another hike, try mountaineering', 'https://backcountrymagazine.com/wp-content/uploads/2017/06/14er_josh_embed_1.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (12, 'Rafting', 'Float the smooth water', 'Tame the rapids', 'https://www.breckenridgewhitewater.com/wp-content/uploads/2013/09/gore-06-8.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (13, 'Rock Climbing', 'Scale a rock wall', 'Sure it is pure stone, don\'t let that stop you', 'https://cdn-files.apstatic.com/climb/107138402_medium_1494168815.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (14, 'Sky Diving', 'So you want to jump out of a perfectly good plane', 'Ok, we will let you use a parachute', 'https://arc-anglerfish-arc2-prod-bonnier.s3.amazonaws.com/public/7LXPZ7ZSIUEV3Z6AGHVQPRXTZY.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (15, 'Snowmobiling', 'Like a motorcycle on snow', 'Speed is needed', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Snowmobiling2_Vail_MI.jpg?itok=vzoORcz2', NULL);
...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (17, 'Ziplining & Aerial Parks', 'Like being a kid...no matter your age', 'Smooth gliding by wire', 'https://www.denverpost.com/wp-content/uploads/2016/05/20120813__20120814_C1_FE14OWCOV_1p2.jpg?w=600', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (18, 'Backpacking', 'All you can carry on your back', 'Keep that in mind...don\'t take your whole closet', 'https://coloradowildernessridesandguides.com/wp-content/uploads/2018/12/20180919_084609.jpeg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (19, 'Camping', 'Who need four walls and a roof', 'Under the stars, canopy, or tent', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/TroutLakeCamping_DC2.jpg?itok=2UO32aZ_', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (20, 'Canoeing', 'Might be a little tipsy', 'Give your arms a workout', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Canoeing4_GrandMesa_GJCVB.jpg?itok=9TSNdUHX', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (21, 'Fishing', 'Fresh fish for dinner', 'Hope you are good...or you may go hungry', 'https://www.denverpost.com/wp-content/uploads/2016/07/fishing-arkansas-river.jpg?w=527', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (22, 'Golf', 'Batters up...wait that\'s not right', 'Swing the club and hit a little ball...can\'t be too hard', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/wintergolf.jpg?itok=_hTTZyKT', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (23, 'Hiking/Walking', 'Hiking is just waling on an undefined sidewalk', 'Wear propper shoes', 'http://www.cannaventure.org/wp-content/uploads/2017/10/royal-arch-trail-boulder-colorado-cannaventure-september-2017-10-1024x683.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (24, 'Horseback Riding', 'Worked for the pioneers', 'Still works today', 'https://media-cdn.tripadvisor.com/media/photo-s/03/d4/3a/e8/stables-at-the-broadmoor.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (25, 'Jet Skiing', 'Your personal jet boat', 'Remember no brakes!', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Jetski1_FortMorgan_MI.jpg?itok=lMwsLrjV', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (26, 'RV Sites', 'Yes you can cook on the road just like at home...microwave', 'You don\'t have to sleep on the ground with a rock perfectly positioned in the middle of you back all night', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWNlKbswxeHCmiQYlirBYc7JBhfrnNtbUPGRFsEZ1lmtZVM1j0', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (27, 'Kayaking', 'More stable than you think...', 'and more efficient than a canoe', 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/70/2b/6e.jpg', NULL);
...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (29, 'Ice Skating', 'How strong are you ankles?', 'And by the way, ice is hard when you crash', 'https://www.mountainliving.com/LakesideVillage_Keystone_Lake_key9400_jack_affleck.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (30, 'Skiing & Snowboarding', 'Much more enjoyable than shoveling', 'But you may still tweek your back', 'https://www.christielodge.com/resourcefiles/attractionsmallimages/colorado-skiing-snowboarding-th.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (31, 'Sleigh Rides', 'Can carry a little more than dog sled...', 'Kinda slow, but emissions free travel', 'http://coloradosleighrides.com/site/wp-content/uploads/2014/09/winter-sleigh-rides.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (32, 'Snowshoeing', 'Just in case you can\'t wait until the snow melts to go hiking', 'Not nearly as painful when you crash as skiing', 'https://i0.wp.com/www.denverpost.com/wp-content/uploads/2016/04/20141224__20141228_E9_TR28HUTHOLIDAYp2.jpg?w=620&crop=0%2C0px%2C100%2C9999px', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (33, 'Boat Tours', 'Let us run aground', 'Hopefully we have enough water this year.', 'http://canyonlandsbynight.com/wp-content/uploads/2015/09/sound-light-show-tour.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (34, 'Eco Tours', 'May include people power...', '...or animal power when traveling', 'http://www.ecotourmachupicchu.com/assets/img/ecotour-logo.png', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (35, 'Scenic Drives', 'Look at all the stuff!', 'Keep you eye on the road', 'https://www.theroamingboomers.com/wp-content/uploads/2012/09/Road-to-Ouray-Colorado.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (36, 'River Rafting & Tubing', 'That\'s not a river...', 'Have you ever seen the Mississippi?', 'https://whitewatertours.com/wp-content/uploads/2016/12/Raft-Blasting-thru-Class-3-Whitewater-on-the-South-Fork-American-River.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (37, 'Canyoning & Rapelling Tours', 'Can sure get back down much quicker', 'Don\'t forget the ropes', 'https://c8.alamy.com/comp/CTJFKB/repelling-down-a-cliff-CTJFKB.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (38, 'Horseback Riding Tours', 'The original All Turain Vehicle', 'You are kinda high off the ground, hold on.', 'http://bozeman-horseback-riding.com/wp-content/uploads/2012/04/Day-Riders-Spanish-Peaks.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (39, 'Day Trips', 'Not night', 'Once you realize a day trip is too short, book another trip', 'https://static.wixstatic.com/media/f6ee89_a87d17bc312c4aaf9e4af7290089eb0e~mv2.png', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (40, 'Train', 'Does anyone still travel that way', 'Keep on the tracks', 'https://www.colorado.com/sites/default/files/styles/640x480/public/zzdata-35555_718x480.jpg?itok=rkR-qywe', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (41, 'Rodeo', 'Why ride a bike or atv...?', 'When you can ride an angry horse...or even better, a BULL! sound great!', 'https://d38trduahtodj3.cloudfront.net/images.ashx?t=ig&rid=StPaulRodeo&i=sb_tyler_corrington_87_on_korkow_rodeos_paint_chip_resized(2).jpg&w=330&h=330&cropbox=1&cropboxhpos=center&stf=1', NULL);
=======
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (1, '4x4 & Jeep Tours', 'Jeep, jeeps, and more jeeps', 'Don\'t worry about bashing up you 4x4, let us do the driving.', 'https://coloradojeeptours.com/wp-content/uploads/chelsy-red-canyon-group.jpeg', 'https://cdn2.iconfinder.com/data/icons/public-transportation-1/32/TRANSPORTATION-07-512.png');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (2, 'Adventure Tours', 'No seriously, let us do the driving while you take in the scenery.', 'Lots to see and more', 'https://captainzipline.com/wp-content/uploads/colorado-zipline-tour-2.jpg', 'https://cdn4.iconfinder.com/data/icons/pirate-2/200/926-512.png');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (3, 'ATV', 'Be sure to wear a helmet', 'Stay on designated trails', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/CO_PhotoProject2007_0515_0.jpg?itok=WZNlrfiO', 'https://cdn4.iconfinder.com/data/icons/elasto-auto-1/26/01-ELASTOFONT-AUTO-READY_atv-512.png');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (4, 'Dog Sledding', 'The dogs do the leg work', 'Dress warmly', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Dogsled3_Edwards_MI_3.jpg?itok=NpUTALq8', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (5, 'Guest/Dude Ranches', 'Watch where you step', 'If you desire to leave your clean, air conditioned, comfy home to come play on the ranch and get a little dirty, we welcome you.', 'https://duderanch.s3.amazonaws.com/2017/03/31/5038.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (6, 'Hang/Paragliding', 'Who needs a plane to fly', 'Ride the wind', 'https://www.uncovercolorado.com/wp-content/uploads/2014/04/Colorado-Paragliding01-1000x500-650x325.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (7, 'Hunting', 'Don\'t settle for store bought meats...', 'We have organic wildlife to hunt (with appropriate license)', 'http://kifaru.net/wp-content/uploads/2018/04/Alex_Nestor.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (8, 'Kayaking', 'Enjoy some time on the water', 'We offer both exciting white water and relaxing flat water kayaking', 'https://kayaksreviewed.com/wp-content/uploads/2018/06/img_8202-1024x683.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (9, 'Motorcycle Touring', 'Join the group with a few or many riders', 'Select the distance and group size you would like to ride with. Safety in numbers', 'https://www.advpulse.com/wp-content/uploads/2016/07/Rawhyde-High-Rockies-Adventure-2.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (10, 'Mountain Biking', 'Trails for all ability levels', 'Smooth and flat, slightly hilly, intense climb/descend and everything in between', 'https://cdn.allsteamboat.com/images/content/5552_14368_Steamboat_Springs_Colorado_Mountain_Biking_lg.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (11, 'Mountaineering', 'Conquere the high peaks', 'Looking for more than just another hike, try mountaineering', 'https://backcountrymagazine.com/wp-content/uploads/2017/06/14er_josh_embed_1.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (12, 'Rafting', 'Float the smooth water', 'Tame the rapids', 'https://www.breckenridgewhitewater.com/wp-content/uploads/2013/09/gore-06-8.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (13, 'Rock Climbing', 'Scale a rock wall', 'Sure it is pure stone, don\'t let that stop you', 'https://cdn-files.apstatic.com/climb/107138402_medium_1494168815.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (14, 'Sky Diving', 'So you want to jump out of a perfectly good plane', 'Ok, we will let you use a parachute', 'https://arc-anglerfish-arc2-prod-bonnier.s3.amazonaws.com/public/7LXPZ7ZSIUEV3Z6AGHVQPRXTZY.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (15, 'Snowmobiling', 'Like a motorcycle on snow', 'Speed is needed', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Snowmobiling2_Vail_MI.jpg?itok=vzoORcz2', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (16, 'Tour/Road Biking', 'Why take a car...', '...you can pedal your way there', 'https://2.bp.blogspot.com/-95Uiku-3iEs/VsZ9rz2MXoI/AAAAAAAC9ZI/CKjXWHzn6Cw/s1600/Thump%2BRace%2BTeam%2Brides%2Bnear%2BLake%2BDillon%2BColorado.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (17, 'Ziplining & Aerial Parks', 'Like being a kid...no matter your age', 'Smooth gliding by wire', 'https://www.denverpost.com/wp-content/uploads/2016/05/20120813__20120814_C1_FE14OWCOV_1p2.jpg?w=600', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (18, 'Backpacking', 'All you can carry on your back', 'Keep that in mind...don\'t take your whole closet', 'https://coloradowildernessridesandguides.com/wp-content/uploads/2018/12/20180919_084609.jpeg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (19, 'Camping', 'Who need four walls and a roof', 'Under the stars, canopy, or tent', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/TroutLakeCamping_DC2.jpg?itok=2UO32aZ_', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (20, 'Canoeing', 'Might be a little tipsy', 'Give your arms a workout', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Canoeing4_GrandMesa_GJCVB.jpg?itok=9TSNdUHX', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (21, 'Fishing', 'Fresh fish for dinner', 'Hope you are good...or you may go hungry', 'https://www.denverpost.com/wp-content/uploads/2016/07/fishing-arkansas-river.jpg?w=527', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (22, 'Golf', 'Batters up...wait that\'s not right', 'Swing the club and hit a little ball...can\'t be too hard', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/wintergolf.jpg?itok=_hTTZyKT', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (23, 'Hiking/Walking', 'Hiking is just waling on an undefined sidewalk', 'Wear propper shoes', 'http://www.cannaventure.org/wp-content/uploads/2017/10/royal-arch-trail-boulder-colorado-cannaventure-september-2017-10-1024x683.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (24, 'Horseback Riding', 'Worked for the pioneers', 'Still works today', 'https://media-cdn.tripadvisor.com/media/photo-s/03/d4/3a/e8/stables-at-the-broadmoor.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (25, 'Jet Skiing', 'Your personal jet boat', 'Remember no brakes!', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Jetski1_FortMorgan_MI.jpg?itok=lMwsLrjV', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (26, 'RV Sites', 'Yes you can cook on the road just like at home...microwave', 'You don\'t have to sleep on the ground with a rock perfectly positioned in the middle of you back all night', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWNlKbswxeHCmiQYlirBYc7JBhfrnNtbUPGRFsEZ1lmtZVM1j0', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (27, 'Kayaking', 'More stable than you think...', 'and more efficient than a canoe', 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/70/2b/6e.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (28, 'Water Skiing', 'Put sticks on you feet, hold on to the rope, try to stay on top of the water', 'You will experience what \"eat water\" means', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Waterskiing2_ChatfieldRes_MI.jpg?itok=yTMlC9Qb', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (29, 'Ice Skating', 'How strong are you ankles?', 'And by the way, ice is hard when you crash', 'https://www.mountainliving.com/LakesideVillage_Keystone_Lake_key9400_jack_affleck.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (30, 'Skiing & Snowboarding', 'Much more enjoyable than shoveling', 'But you may still tweek your back', 'https://www.christielodge.com/resourcefiles/attractionsmallimages/colorado-skiing-snowboarding-th.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (31, 'Sleigh Rides', 'Can carry a little more than dog sled...', 'Kinda slow, but emissions free travel', 'http://coloradosleighrides.com/site/wp-content/uploads/2014/09/winter-sleigh-rides.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (32, 'Snowshoeing', 'Just in case you can\'t wait until the snow melts to go hiking', 'Not nearly as painful when you crash as skiing', 'https://i0.wp.com/www.denverpost.com/wp-content/uploads/2016/04/20141224__20141228_E9_TR28HUTHOLIDAYp2.jpg?w=620&crop=0%2C0px%2C100%2C9999px', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (33, 'Boat Tours', 'Let us run aground', 'Hopefully we have enough water this year.', 'http://canyonlandsbynight.com/wp-content/uploads/2015/09/sound-light-show-tour.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (34, 'Eco Tours', 'May include people power...', '...or animal power when traveling', 'http://www.ecotourmachupicchu.com/assets/img/ecotour-logo.png', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (35, 'Scenic Drives', 'Look at all the stuff!', 'Keep you eye on the road', 'https://www.theroamingboomers.com/wp-content/uploads/2012/09/Road-to-Ouray-Colorado.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (36, 'River Rafting & Tubing', 'That\'s not a river...', 'Have you ever seen the Mississippi?', 'https://whitewatertours.com/wp-content/uploads/2016/12/Raft-Blasting-thru-Class-3-Whitewater-on-the-South-Fork-American-River.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (37, 'Canyoning & Rapelling Tours', 'Can sure get back down much quicker', 'Don\'t forget the ropes', 'https://c8.alamy.com/comp/CTJFKB/repelling-down-a-cliff-CTJFKB.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (38, 'Horseback Riding Tours', 'The original All Turain Vehicle', 'You are kinda high off the ground, hold on.', 'http://bozeman-horseback-riding.com/wp-content/uploads/2012/04/Day-Riders-Spanish-Peaks.jpg', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (39, 'Day Trips', 'Not night', 'Once you realize a day trip is too short, book another trip', 'https://static.wixstatic.com/media/f6ee89_a87d17bc312c4aaf9e4af7290089eb0e~mv2.png', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (40, 'Train', 'Does anyone still travel that way', 'Keep on the tracks', 'https://www.colorado.com/sites/default/files/styles/640x480/public/zzdata-35555_718x480.jpg?itok=rkR-qywe', NULL);
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_url`) VALUES (41, 'Rodeo', 'Why ride a bike or atv...?', 'When you can ride an angry horse...or even better, a BULL! sound great!', 'https://d38trduahtodj3.cloudfront.net/images.ashx?t=ig&rid=StPaulRodeo&i=sb_tyler_corrington_87_on_korkow_rodeos_paint_chip_resized(2).jpg&w=330&h=330&cropbox=1&cropboxhpos=center&stf=1', NULL);
>>>>>>> master
...
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (2, 'Restaurants', 'The best roadkill in the west', 'Colorado restaurants range from fine dining experience to fastfood chains or food truchs. Featuring a variety of cuizines from around the word.  And, you’ll find plenty of great dining options at any price point.', 'https://static.thenounproject.com/png/636328-200.png');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (3, 'Gas Stations', 'Refuel and go', 'Connoco, Texaco, Ammaco, BP, Shell, gasoline and deisel available', 'https://image.flaticon.com/icons/png/512/35/35135.png');
...
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (3, 7);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (3, 8);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (3, 9);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 10);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 11);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 12);
...
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 7);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 8);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 9);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 10);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 11);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 12);
