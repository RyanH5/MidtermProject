...
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (2, 'Adventure Tours', 'No seriously, let us do the driving while you take in the scenery.', 'Lots to see and more', 'https://captainzipline.com/wp-content/uploads/colorado-zipline-tour-2.jpg', '<i class=\"fas fa-truck-monster\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (3, 'ATV', 'Be sure to wear a helmet', 'Stay on designated trails', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/CO_PhotoProject2007_0515_0.jpg?itok=WZNlrfiO', '<i class=\"fas fa-truck-monster\"></i>');
