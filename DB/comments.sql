...
START TRANSACTION;
USE `trippingdb`;
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `image_url`, `role`, `active`) VALUES (1, 'ryanh5', 'pw', 'Ryan', 'Last', ' harr@gmail.com', ' 2015-07-11 11:00:00', 'https://i.pinimg.com/originals/a9/ee/44/a9ee4406650438b8e098163b0fe070a6.jpg', 'notAdmin', 0);
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `image_url`, `role`, `active`) VALUES (2, 'craigh', 'pw', 'Craig', 'Last', ' smith@gmail.com', ' 2015-07-11 11:00:00', 'https://amp.businessinsider.com/images/56b518716e97c623048b55ea-1136-852.jpg', 'admin', 1);
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `image_url`, `role`, `active`) VALUES (3, 'chana', 'pw', 'Chana', 'Last', ' chana@gmail.com', ' 2015-07-11 11:00:00', 'https://www.ewawomen.com/wp-content/uploads/2017/06/fotonoticia_20170519143811_640.jpg', 'notAdmin', 0);
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `image_url`, `role`, `active`) VALUES (4, 'cecil', 'pw', 'Cecil', 'Kitch', 'labcecil@gmail.com', ' 2015-07-11 11:00:00', 'https://i2.wp.com/www.comicsbeat.com/wp-content/uploads/2014/09/iron_man.png', 'notAdmin', 1);
...
START TRANSACTION;
USE `trippingdb`;
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (1, '4x4 & Jeep Tours', 'Jeep, jeeps, and more jeeps', 'Don\'t worry about bashing up you 4x4, let us do the driving.', 'https://coloradojeeptours.com/wp-content/uploads/chelsy-red-canyon-group.jpeg', '<i class=\"fas fa-truck-pickup\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (2, 'Adventure Tours', 'No seriously, let us do the driving while you take in the scenery.', 'Lots to see and more', 'https://captainzipline.com/wp-content/uploads/colorado-zipline-tour-2.jpg', '<i class=\"far fa-compass\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (3, 'ATV', 'Be sure to wear a helmet', 'Stay on designated trails', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/CO_PhotoProject2007_0515_0.jpg?itok=WZNlrfiO', '<i class=\"fas fa-dog\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (4, 'Dog Sledding', 'The dogs do the leg work', 'Dress warmly', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Dogsled3_Edwards_MI_3.jpg?itok=NpUTALq8', '<i class=\"fas fa-dog\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (5, 'Guest/Dude Ranches', 'Watch where you step', 'If you desire to leave your clean, air conditioned, comfy home to come play on the ranch and get a little dirty, we welcome you.', 'https://duderanch.s3.amazonaws.com/2017/03/31/5038.jpg', '<i class=\"fas fa-tree\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (6, 'Hang/Paragliding', 'Who needs a plane to fly', 'Ride the wind', 'https://www.uncovercolorado.com/wp-content/uploads/2014/04/Colorado-Paragliding01-1000x500-650x325.jpg', '<i class=\"fab fa-fly\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (7, 'Hunting', 'Don\'t settle for store bought meats...', 'We have organic wildlife to hunt (with appropriate license)', 'http://kifaru.net/wp-content/uploads/2018/04/Alex_Nestor.jpg', '<i class=\"fas fa-fighter-jet\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (8, 'Kayaking', 'Enjoy some time on the water', 'We offer both exciting white water and relaxing flat water kayaking', 'https://kayaksreviewed.com/wp-content/uploads/2018/06/img_8202-1024x683.jpg', '<i class=\"fas fa-tenge\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (9, 'Motorcycle Touring', 'Join the group with a few or many riders', 'Select the distance and group size you would like to ride with. Safety in numbers', 'https://www.advpulse.com/wp-content/uploads/2016/07/Rawhyde-High-Rockies-Adventure-2.jpg', '<i class=\"fas fa-motorcycle\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (10, 'Mountain Biking', 'Trails for all ability levels', 'Smooth and flat, slightly hilly, intense climb/descend and everything in between', 'https://cdn.allsteamboat.com/images/content/5552_14368_Steamboat_Springs_Colorado_Mountain_Biking_lg.jpg', '<i class=\"fas fa-biking\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (11, 'Mountaineering', 'Conquere the high peaks', 'Looking for more than just another hike, try mountaineering', 'https://backcountrymagazine.com/wp-content/uploads/2017/06/14er_josh_embed_1.jpg', '<i class=\"fas fa-mountain\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (12, 'Rafting', 'Float the smooth water', 'Tame the rapids', 'https://www.breckenridgewhitewater.com/wp-content/uploads/2013/09/gore-06-8.jpg', '<i class=\"fab fa-firstdraft\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (13, 'Rock Climbing', 'Scale a rock wall', 'Sure it is pure stone, don\'t let that stop you', 'https://cdn-files.apstatic.com/climb/107138402_medium_1494168815.jpg', '<i class=\"fab fa-rockrms\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (14, 'Sky Diving', 'So you want to jump out of a perfectly good plane', 'Ok, we will let you use a parachute', 'https://arc-anglerfish-arc2-prod-bonnier.s3.amazonaws.com/public/7LXPZ7ZSIUEV3Z6AGHVQPRXTZY.jpg', '<i class=\"fas fa-jedi\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (15, 'Snowmobiling', 'Like a motorcycle on snow', 'Speed is needed', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Snowmobiling2_Vail_MI.jpg?itok=vzoORcz2', '<i class=\"fas fa-sleigh\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (16, 'Tour/Road Biking', 'Why take a car...', '...you can pedal your way there', 'https://2.bp.blogspot.com/-95Uiku-3iEs/VsZ9rz2MXoI/AAAAAAAC9ZI/CKjXWHzn6Cw/s1600/Thump%2BRace%2BTeam%2Brides%2Bnear%2BLake%2BDillon%2BColorado.jpg', '<i class=\"fas fa-bicycle\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (17, 'Ziplining & Aerial Parks', 'Like being a kid...no matter your age', 'Smooth gliding by wire', 'https://www.denverpost.com/wp-content/uploads/2016/05/20120813__20120814_C1_FE14OWCOV_1p2.jpg?w=600', '<i class=\"fas fa-file-archive\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (18, 'Backpacking', 'All you can carry on your back', 'Keep that in mind...don\'t take your whole closet', 'https://coloradowildernessridesandguides.com/wp-content/uploads/2018/12/20180919_084609.jpeg', '<i class=\"fas fa-hiking\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (19, 'Camping', 'Who need four walls and a roof', 'Under the stars, canopy, or tent', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/TroutLakeCamping_DC2.jpg?itok=2UO32aZ_', '<i class=\"fas fa-campground\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (20, 'Canoeing', 'Might be a little tipsy', 'Give your arms a workout', 'https://2.bp.blogspot.com/-qWGRN0PYzMA/V3bAbxMwaYI/AAAAAAAAB3U/kLZus1M2nLcXhjs49pMLrjrnGP3IzjLJgCKgB/s1600/13411851_10153862276073547_8840792291443099981_o.jpg', '<i class=\"fas fa-ship\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (21, 'Fishing', 'Fresh fish for dinner', 'Hope you are good...or you may go hungry', 'https://www.denverpost.com/wp-content/uploads/2016/07/fishing-arkansas-river.jpg?w=527', '<i class=\"fas fa-fish\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (22, 'Golf', 'Batters up...wait that\'s not right', 'Swing the club and hit a little ball...can\'t be too hard', 'https://www.colorado.com/sites/default/files/styles/1000x685/public/wintergolf.jpg?itok=_hTTZyKT', '<i class=\"fas fa-golf-ball\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (23, 'Hiking/Walking', 'Hiking is just waling on an undefined sidewalk', 'Wear propper shoes', 'http://www.cannaventure.org/wp-content/uploads/2017/10/royal-arch-trail-boulder-colorado-cannaventure-september-2017-10-1024x683.jpg', '<i class=\"fas fa-hiking\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (24, 'Horseback Riding', 'Worked for the pioneers', 'Still works today', 'https://media-cdn.tripadvisor.com/media/photo-s/03/d4/3a/e8/stables-at-the-broadmoor.jpg', '<i class=\"fas fa-horse\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (25, 'Jet Skiing', 'Your personal jet boat', 'Remember no brakes!', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Jetski1_FortMorgan_MI.jpg?itok=lMwsLrjV', '<i class=\"fas fa-skiing\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (26, 'RV Sites', 'Yes you can cook on the road just like at home...microwave', 'You don\'t have to sleep on the ground with a rock perfectly positioned in the middle of you back all night', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWNlKbswxeHCmiQYlirBYc7JBhfrnNtbUPGRFsEZ1lmtZVM1j0', '<i class=\"fas fa-plug\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (27, 'Kayaking', 'More stable than you think...', 'and more efficient than a canoe', 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/70/2b/6e.jpg', '<i class=\"fab fa-bootstrap\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (28, 'Water Skiing', 'Put sticks on you feet, hold on to the rope, try to stay on top of the water', 'You will experience what \"eat water\" means', 'https://www.colorado.com/sites/default/files/styles/media-player-large/public/Waterskiing2_ChatfieldRes_MI.jpg?itok=yTMlC9Qb', '<i class=\"fas fa-skiing\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (29, 'Ice Skating', 'How strong are you ankles?', 'And by the way, ice is hard when you crash', 'https://www.mountainliving.com/LakesideVillage_Keystone_Lake_key9400_jack_affleck.jpg', '<i class=\"fas fa-skating\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (30, 'Skiing & Snowboarding', 'Much more enjoyable than shoveling', 'But you may still tweek your back', 'https://www.christielodge.com/resourcefiles/attractionsmallimages/colorado-skiing-snowboarding-th.jpg', '<i class=\"fas fa-snowboarding\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (31, 'Sleigh Rides', 'Can carry a little more than dog sled...', 'Kinda slow, but emissions free travel', 'http://coloradosleighrides.com/site/wp-content/uploads/2014/09/winter-sleigh-rides.jpg', '<i class=\"fas fa-skiing-nordic\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (32, 'Snowshoeing', 'Just in case you can\'t wait until the snow melts to go hiking', 'Not nearly as painful when you crash as skiing', 'https://i0.wp.com/www.denverpost.com/wp-content/uploads/2016/04/20141224__20141228_E9_TR28HUTHOLIDAYp2.jpg?w=620&crop=0%2C0px%2C100%2C9999px', '<i class=\"fas fa-snowboarding\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (33, 'Boat Tours', 'Let us run aground', 'Hopefully we have enough water this year.', 'http://canyonlandsbynight.com/wp-content/uploads/2015/09/sound-light-show-tour.jpg', '<i class=\"fas fa-ship\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (34, 'Eco Tours', 'May include people power...', '...or animal power when traveling', 'http://www.ecotourmachupicchu.com/assets/img/ecotour-logo.png', '<i class=\"fas fa-leaf\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (35, 'Scenic Drives', 'Look at all the stuff!', 'Keep you eye on the road', 'https://www.theroamingboomers.com/wp-content/uploads/2012/09/Road-to-Ouray-Colorado.jpg', '<i class=\"fas fa-binoculars\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (36, 'River Rafting & Tubing', 'That\'s not a river...', 'Have you ever seen the Mississippi?', 'https://whitewatertours.com/wp-content/uploads/2016/12/Raft-Blasting-thru-Class-3-Whitewater-on-the-South-Fork-American-River.jpg', '<i class=\"fas fa-water\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (37, 'Canyoning & Rapelling Tours', 'Can sure get back down much quicker', 'Don\'t forget the ropes', 'https://c8.alamy.com/comp/CTJFKB/repelling-down-a-cliff-CTJFKB.jpg', '<i class=\"fas fa-tram\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (38, 'Horseback Riding Tours', 'The original All Turain Vehicle', 'You are kinda high off the ground, hold on.', 'http://bozeman-horseback-riding.com/wp-content/uploads/2012/04/Day-Riders-Spanish-Peaks.jpg', '<i class=\"fas fa-horse\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (39, 'Day Trips', 'Not night', 'Once you realize a day trip is too short, book another trip', 'https://static.wixstatic.com/media/f6ee89_a87d17bc312c4aaf9e4af7290089eb0e~mv2.png', '<i class=\"fas fa-car\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (40, 'Train', 'Does anyone still travel that way', 'Keep on the tracks', 'https://www.colorado.com/sites/default/files/styles/640x480/public/zzdata-35555_718x480.jpg?itok=rkR-qywe', '<i class=\"fas fa-train\"></i>');
INSERT INTO `activity` (`id`, `name`, `short_description`, `long_description`, `image_url`, `icon_tag`) VALUES (41, 'Rodeo', 'Why ride a bike or atv...?', 'When you can ride an angry horse...or even better, a BULL! sound great!', 'https://d38trduahtodj3.cloudfront.net/images.ashx?t=ig&rid=StPaulRodeo&i=sb_tyler_corrington_87_on_korkow_rodeos_paint_chip_resized(2).jpg&w=330&h=330&cropbox=1&cropboxhpos=center&stf=1', '<i class=\"fas fa-horse\"></i>');
...
INSERT INTO `journal_entry` (`id`, `user_id`, `is_public`, `is_complete`, `title`, `entry_text`, `create_date`, `destination_id`, `event_id`, `activitity_id`) VALUES (2, 2, 0, 1, 'Trip to Dinosaur', 'Tell me about your fake trip', '2019-07-01 11:00:00', 2, 2, 2);
INSERT INTO `journal_entry` (`id`, `user_id`, `is_public`, `is_complete`, `title`, `entry_text`, `create_date`, `destination_id`, `event_id`, `activitity_id`) VALUES (3, 2, 1, 0, 'Trip to Golden', 'Tell me about your fake trip', '2019-07-01 11:00:00', 3, 3, 3);
...
INSERT INTO `journal_entry` (`id`, `user_id`, `is_public`, `is_complete`, `title`, `entry_text`, `create_date`, `destination_id`, `event_id`, `activitity_id`) VALUES (5, 4, 1, 0, 'Trip to Boulder', 'Tell me about your fake trip', '2019-07-01 11:00:00', 5, 5, 5);
...
INSERT INTO `journal_entry` (`id`, `user_id`, `is_public`, `is_complete`, `title`, `entry_text`, `create_date`, `destination_id`, `event_id`, `activitity_id`) VALUES (7, 3, 1, 0, 'Trip to Durango', 'Tell me about your fake trip', '2019-07-01 11:00:00', 7, 7, 7);
...
INSERT INTO `journal_entry` (`id`, `user_id`, `is_public`, `is_complete`, `title`, `entry_text`, `create_date`, `destination_id`, `event_id`, `activitity_id`) VALUES (10, 1, 1, 0, 'Trip to Telluride', 'Tell me about your fake trip', '2019-07-01 11:00:00', 10, 10, 10);
...
START TRANSACTION;
USE `trippingdb`;
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (1, 'Lodging', 'Please, come stay and enjoy your visit', 'Colorado hotels and lodging range from five-star luxury hotels to rustic cabins. Whether it’s a city hotel, mountain resort, historic B&B or alpine lodge, Colorado accommodations provide amazing views, values and a variety of places to stay. Choose between the largest international hotel chains to small inns. And, you’ll find plenty of great dining options and activities no matter where you stay in Colorado.', '<i class=\"fas fa-hotel\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (2, 'Restaurants', 'The best roadkill in the west', 'Colorado restaurants range from fine dining experience to fastfood chains or food truchs. Featuring a variety of cuizines from around the word.  And, you’ll find plenty of great dining options at any price point.', '<i class=\"fas fa-utensils\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (3, 'Gas Stations', 'Refuel and go', 'Connoco, Texaco, Ammaco, BP, Shell, gasoline and deisel available', '<i class=\"fas fa-gas-pump\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (4, 'Pets Allowed', 'Dog friendly', 'Dogs welcome in all outdoor areas on a leash at our descretion (owners required to clean up after their dogs)', '<i class=\"fas fa-paw\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (5, 'Family Friendly', 'Bring the rug rats', 'Play area available for children, stroller accessable', '<i class=\"fas fa-frog\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (6, 'Accessible', 'Wheelchair accessible', 'ADA parking, wheelchair ramps, easy access concrete path', '<i class=\"fab fa-accessible-icon\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (7, 'Indoor parking', 'Indoor parking limited (arrive early)', 'Shaded, not climate controlled', '<i class=\"fas fa-parking\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (8, 'Free wifi', 'WIFI details on flyer', 'WIFI may be slow due to minimal band width', '<i class=\"fas fa-wifi\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (9, 'Bicycle friendly', 'Two wheeler always welcome', 'Bike storage available, bring your own lock, not responsible for damaged or stolen bikes', '<i class=\"fas fa-bicycle\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (10, 'Indoor pool', 'Splash around...not too much', 'Enjoy the pool and cool down', '<i class=\"fas fa-swimming-pool\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (11, 'Hot tub', 'Relax for a while', 'Let the massage jets soothe your sore muscles', '<i class=\"fas fa-hot-tub\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (12, 'Online Reservations', 'Discounts  may apply', 'Discounts may be seasonal', '<i class=\"fas fa-envelope-open-text\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (13, 'Alcohol Permitted', 'Permitted on private property', 'No glass bottles', '<i class=\"fas fa-glass-cheers\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (14, 'Campsites Available', 'First come first served (limit 7 consecutive days)', 'RV and tent sites', '<i class=\"fas fa-campground\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (15, 'RV Hookup', 'Additional charge above camp fee', 'Electric, water, dump station', '<i class=\"fas fa-shuttle-van\"></i>');
INSERT INTO `amenity` (`id`, `name`, `short_description`, `long_description`, `icon_url`) VALUES (16, 'Shuttles Available', 'Free shuttle to all events', 'All shuttles ADA accessable', '<i class=\"fas fa-shuttle-van\"></i>');
...
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (20, 7, 'https://www.mesacounty.us/globalassets/fairgrounds/fair/fair-at-night.png');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (21, 7, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1-mdq1z57nNQFppfeltqvM8HjhrjYCpi1MKiGobcgYpxKgzuB');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (22, 8, 'https://assets.simpleviewinc.com/simpleview/image/upload/c_fill,h_645,q_50,w_1024/v1/clients/denver/WomensCrit_BrettStakelin_006_595c0e12-1aed-41da-bdec-57f1228a6894.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (23, 8, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (24, 8, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (25, 9, 'https://assets.simpleviewinc.com/simpleview/image/fetch/c_fill,h_421,q_75,w_561/https://assets.simpleviewinc.com/simpleview/image/upload/crm/goldenco/Gallop42570297_1424858324325717_1807678033247600640_o0_9a54b6d9-5056-a36a-095b8fbcb4b82cd0.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (26, 9, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (27, 9, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (28, 10, 'https://www.fortcarsonmountaineer.com/wp-content/uploads/2017/08/08-11-17-GreekFestival01-300x219.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (29, 10, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (30, 10, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (31, 11, 'https://www.singleblackmale.org/wp-content/uploads/2013/05/glass-of-beer-240x300.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (32, 11, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (33, 11, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (34, 12, 'https://www.csbj.com/wp-content/uploads/2015/09/labor-day-lift-off-19.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (35, 12, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (36, 12, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (37, 13, 'https://yourboulder.com/wp-content/uploads/2014/03/boulder-craft-beer-w564.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (38, 13, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (39, 13, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (40, 14, 'https://res.cloudinary.com/dostuff-media/image/upload//c_fill,g_faces,h_630,w_1200/v1556046690/event-10658988.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (41, 14, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (42, 14, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (43, 15, 'https://s25317.pcdn.co/wp-content/uploads/2019/05/EClark_180721_5392-480x360.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (44, 15, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (45, 15, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (46, 16, 'https://www.aspenmusicfestival.com/images/uploads/generic/AboutPage_tentimage.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (47, 16, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (48, 16, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (49, 17, 'http://jazzaspensnowmass.org/home/jas/.blogs/post7343/jas_labordayimg.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (50, 17, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (51, 17, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (52, 18, 'https://www.gosnowmass.com/wp-content/uploads/2017/04/Snowmass_BalloonFest_JS16_34A5548_NoExp_ADJ_yellow-fix.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (53, 18, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (54, 18, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (55, 19, 'https://i.ytimg.com/vi/zx-TheSU5RY/maxresdefault.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (56, 19, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (57, 19, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (58, 20, 'https://cdn-az.allevents.in/events7/banners/e5cbe3c0-a5e1-11e9-b1e4-8b490307ce45-rimg-w526-h935-gmir.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (59, 20, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (60, 20, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (61, 21, 'https://durangomeltdown.com/wp-content/uploads/2015/09/Mesa-1-RT-_MG_2003.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (62, 21, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (63, 21, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (64, 22, 'https://bloximages.newyork1.vip.townnews.com/gazette.com/content/tncms/assets/v3/editorial/1/6f/16f49970-5eda-5fdc-b828-bc903c042494/5b340aab3672e.image.jpg?resize=1200%2C799');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (65, 22, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (66, 22, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (67, 23, 'https://chambermaster.blob.core.windows.net/userfiles/UserFiles/chambers/2612/CMS/Carshow_2010_Vettes.JPG');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (68, 23, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (69, 23, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (70, 24, 'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F62493878%2F133265307545%2F1%2Foriginal.20190517-214121?w=800&auto=compress&rect=0%2C75%2C602%2C301&s=baff6fb3a0b50a135eb67b14f1c97a71');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (71, 24, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (72, 24, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (73, 25, 'https://c8.alamy.com/comp/ERHTEB/summer-farmers-market-on-main-street-in-parker-colorado-ERHTEB.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (74, 25, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (75, 25, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (76, 26, 'https://thumbs-prod.si-cdn.com/k9fN_VKjXkfx5LDZQGFnF6jLtQc=/800x600/filters:no_upscale()/https://public-media.si-cdn.com/filer/03/28/0328dd7d-06f1-48b5-89e4-f7b62391058a/nhb2017-01944.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (77, 26, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (78, 26, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (79, 27, 'https://monumentaltix.com/assets/uploads/monumentalevents/2016/11/324e4e0b23987d10ea15349dac4d183a_event-medium.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (80, 27, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (81, 27, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (82, 28, 'https://2ab9pu2w8o9xpg6w26xnz04d-wpengine.netdna-ssl.com/wp-content/uploads/2018/03/telluride-jazz-festival-glory-live-performance-980x516.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (83, 28, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (84, 28, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (85, 29, 'https://carsandcolors.com/wp-content/uploads/2018/11/DVS_5101-s.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (86, 29, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (87, 29, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (88, 30, 'https://bloximages.newyork1.vip.townnews.com/gazette.com/content/tncms/assets/v3/editorial/e/00/e0086925-977a-5b6d-b5f7-adba9b14c6e4/5b201a991a78a.image.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (89, 30, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (90, 30, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (91, 31, 'https://nationalwestern.com/wp-content/uploads/2014/09/NWSSParadeLonghornsLogo-e1409850914400.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (92, 31, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (93, 31, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (94, 32, 'https://cdn.theatlantic.com/assets/media/img/photo/2018/09/oktoberfest-2018-photos-from-the-op/m08_1037653502/main_900.jpg?1537812587');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (95, 32, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (96, 32, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (97, 33, 'https://s3-us-west-2.amazonaws.com/brewersassoc/wp-content/uploads/2015/09/ba_belco.jpg');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (98, 33, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (99, 33, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (100, 34, 'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F58855917%2F173875186647%2F1%2Foriginal.20190321-013006?w=1000&auto=compress&rect=0%2C46%2C960%2C480&s=4945d5cace144f062eea523457f9130f');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (101, 34, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (102, 34, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (103, 35, 'https://cdn.postindependent.com/wp-content/uploads/sites/6/2019/06/carbondale-art-walk-1024x590.png');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (104, 35, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (105, 35, '');
INSERT INTO `event_image` (`id`, `event_id`, `image_url`) VALUES (106, 36, 'https://img.cheapair.com/uploads/2016/11/shutterstock_155409377.jpg');
...
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (2, 2);
...
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (3, 2);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (3, 3);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 1);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 2);
INSERT INTO `point_of_interest_has_amenity` (`point_of_interest_id`, `amenity_id`) VALUES (4, 3);
...
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (2, 1);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (2, 2);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (2, 3);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 1);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 2);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (3, 3);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 1);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 2);
INSERT INTO `point_of_interest_has_activity` (`point_of_interest_id`, `activity_id`) VALUES (4, 3);
...
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (2, 1, 2, 'sometext', 4, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (3, 1, 3, 'sometext', 3, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (4, 1, 4, 'sometext', 2, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (5, 2, 1, 'sometext', 3, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (6, 2, 2, 'sometext', 4, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (7, 2, 3, 'sometext', 1, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (8, 2, 4, 'sometext', 3, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (9, 3, 1, 'sometext', 4, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (10, 3, 2, 'sometext', 5, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (11, 3, 3, 'sometext', 2, NULL);
INSERT INTO `point_of_interest_comment` (`id`, `user_id`, `poi_id`, `comment_text`, `rating`, `comment_date`) VALUES (12, 3, 4, 'sometext', 1, NULL);
