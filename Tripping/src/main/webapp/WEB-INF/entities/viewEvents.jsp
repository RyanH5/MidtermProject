...
<body class="index-page sidebar-collapse">
	<nav class="navbar navbar-expand-lg fixed-top"
		style="background-color: #B0E0E6;"300">
		<div class="container">
			<div class="navbar-translate">
				<i class="fa fa-user-o" aria-hidden="true"></i> <a
					class="navbar-brand" href="login" rel="tooltip" title="login"
			...
			<div class="navbar-translate">
				<a class="navbar-brand" href="register.do" rel="tooltip"
                ...
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                  ...
                  <div>
                    ...
                    <a href="#paper-kit" class="btn btn-link btn-danger fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
									...
									<h6>
										Privacy <span class="icon-danger">*</span>
									</h6>
									<div class="form-check-radio">
										<label class="form-check-label"> <input
											class="form-check-input" type="radio" name="exampleRadios"
											id="exampleRadios1" value="option1"> Public <span
									...
									<div class="form-check-radio">
										<label class="form-check-label"> <input
											...
											Private <span class="form-check-sign"></span>
										</label>
									</div>
								</div>
								<div class="col-md-7 col-sm-7">
									...
									<div class="form-group">
										...
										<textarea class="form-control textarea-limited" placeholder=""
											rows="13" maxlength="4500"></textarea>
										<h5>
											<small> <span id="textarea-limited-message"
												class="pull-right">4500 characters left</span>
											</small>
										</h5>
									</div>
								</div>
