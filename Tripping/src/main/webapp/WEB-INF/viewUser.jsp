	...
	<c:choose>
		<c:when test="${sessionScope.user.role.equals('admin')}">
			<ul class="nav nav-pills card-header-pills">
				...
				<li class="nav-item"><a class="nav-link disabled" href="#">Inactive</a>
				</li>
			</ul>
			<ul class="nav nav-pills card-header-pills">
				<li class="nav-item"><a class="nav-link disabled" href="">Admin</a>
				<li class="nav-item"><a class="nav-link active" href="#">WebUser</a>
				</li>
			</ul>
		</c:when>
	</c:choose>
